...
function add_link_files() {
  // CSSの読み込み
  wp_enqueue_style( 'slick', get_template_directory_uri().'/common/css/slick.min.css' );
  ...
  wp_enqueue_script( 'index', get_template_directory_uri().'/common/js/index.js', array('jquery'), false, true );
  wp_enqueue_script( 'inview', get_template_directory_uri().'/common/js/jquery.inview.min.js', array('jquery'), false, true );
  ...
  if ( is_page('service') ) {
    wp_enqueue_script( 'service', get_template_directory_uri().'/common/js/service.js', array('jquery'), false, true );
  }
  if ( is_page('recruit') ) {
    wp_enqueue_script( 'recruit', get_template_directory_uri().'/common/js/recruit.js', array('jquery'), false, true );
  }
}
