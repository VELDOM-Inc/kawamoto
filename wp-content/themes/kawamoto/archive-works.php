<?php get_header(); ?>
		...
		<div class="c-works__inner">
			...
			<div class="c-works-category">
				<div class="c-works-category__list">
					<div class="c-works-category__ttl">CATEGORY</div>
			...
			<div class="c-works-list">
				...
				<div class="c-works-list__item is-fade">
					<a class="c-works-list__link" href="<?php the_permalink(); ?>">
						...
						<p class="c-works-list__ttl"><?php the_title(); ?></p>
	...
	<div class="c-breadcrumb">
		<div class="c-breadcrumb__inner">
        	...
        	<span class="c-breadcrumb__item __active">実績紹介</span>
		</div>
    </div>
